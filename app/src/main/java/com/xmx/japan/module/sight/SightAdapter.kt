 ...
 */
class SightAdapter(context: Context, data: List<Sight>) : BaseEntityAdapter<Sight>(context, data) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (view == null) {
            // 若没有则创建新的ViewHolder
            view = LayoutInflater.from(mContext).inflate(R.layout.item_sight, null)
            if (view != null) {
                holder = ViewHolder()
                holder.view = view
