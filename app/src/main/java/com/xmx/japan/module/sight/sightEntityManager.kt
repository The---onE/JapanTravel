...
import com.xmx.japan.common.data.DataConstants
import com.xmx.japan.common.data.sync.BaseSyncEntityManager
 ...
 */
object sightEntityManager : BaseSyncEntityManager<Sight>() {

    init {
        // 初始化表名、模版、用户字段
        syncInit("Sight", Sight(), "User")
    }
